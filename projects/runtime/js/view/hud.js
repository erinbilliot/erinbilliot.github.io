(function (window) {
    ...
    window.opspark.makeHud = function () {
        ...
        background = draw.rect(100, 20, '#2e185f');
        draw.rect(102, 18, '#2e185f', null, null, 1, 1, background);
        integrity.addChild(background);
        
        txtScore = draw.textfield('score : 000', "19px Arial", '#dfdfdf', 'left');
        hud.addChild(txtScore);
        
        integrityMeter = draw.rect(1, 16, '#ff9ac6');
